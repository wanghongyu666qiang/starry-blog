...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: absoluteUrl("/columns"), lastModified: staticModified, changeFrequency: "monthly", priority: 0.8 },
    { url: absoluteUrl("/columns/algorithms"), lastModified: staticModified, changeFrequency: "weekly", priority: 0.8 },
